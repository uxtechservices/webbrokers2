  ...
  <header
    ...
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      <div
        ...
        <button @click="handleToggle" v-if="!goBack"
        ...
        <button @click="toggleApplicationMenu"  v-if="!goBack"
        ...
        <button @click="router.go(-1)" v-if="goBack"
          class="flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
          :class="[
            isMobileOpen
              ? 'lg:bg-transparent dark:lg:bg-transparent bg-gray-100 dark:bg-gray-800'
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="24" viewBox="0 0 2048 2048"><path fill="currentColor" d="M2048 1024H392l674 674l-144 145L0 922L922 0l144 145l-674 674h1656z"/></svg>
        </button>
      </div>
...
const props = defineProps({ goBack: { type: Boolean, required: false, default: false } })
